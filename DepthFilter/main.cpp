...
int main(int argv, char** argc)
{
    ...
    // depth_filter.Initialize(0.00, 0.00, filter_type);
    ...
    // 保存结果
    std::string disp_map_path = argc[1]; disp_map_path += ".1d.png";
    std::string disp_color_map_path = argc[1]; disp_color_map_path += ".1c.png";
