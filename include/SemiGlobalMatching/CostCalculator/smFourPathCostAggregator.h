...
namespace SemiGlobalMatching {
    ...
    public:
        ...
        virtual void smCostAggregateLR(u8* imageData, u32* costMatrix,u32 imageWidth,u32 imageHeight, i32 minDisparity, u32 disparityRange, u32* refinedMatrix,u8 direction);
        virtual void smCostAggregateUD(u8* imageData, u32* costMatrix,u32 imageWidth,u32 imageHeight, i32 minDisparity, u32 disparityRange, u32* refinedMatrix,u8 direction);
    };
}