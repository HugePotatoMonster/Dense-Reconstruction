...
namespace SemiGlobalMatching {
	...
	public:
		...
		void smDisparityMapDiscretization(f64* disparityMap, u32* outputMap, u32 imageWidth, u32 imageHeight,i32 minDisparity, u32 disparityRange, u32 invalidPlaceholder = 0);
